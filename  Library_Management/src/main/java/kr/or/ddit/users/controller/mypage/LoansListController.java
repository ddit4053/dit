...
@WebServlet("/user/mypage/loansList.do")
public class LoansListController extends AbstractPagingController {
    ...
    protected int getTotalCount(int userNo) {
        return userService.getTotalLoansCount(userNo);
    }

    @Override
    protected List<Map<String, Object>> getDataList(Map<String, Object> pagingParams) {
        return userService.loansList(pagingParams);
    }

    @Override
    protected String getContentPage() {
        return "loansList.jsp";
    }

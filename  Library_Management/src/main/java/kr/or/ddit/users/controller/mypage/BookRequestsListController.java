...
@WebServlet("/user/mypage/bookReqList.do")
public class BookRequestsListController extends AbstractPagingController {
    ...
    protected int getTotalCount(int userNo) {
        return userService.getTotalBookRequestsCount(userNo);
    }

    @Override
    protected List<Map<String, Object>> getDataList(Map<String, Object> pagingParams) {
        return userService.bookRequestsList(pagingParams);
    }

    @Override
    protected String getContentPage() {
        return "bookRequestsList.jsp";
    }

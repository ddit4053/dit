...
<div class="info-content ${isAdmin ? 'admin' : ''}">
    <div class="info-content-header">
        ...
        <div class="boardTopOption">
            ...
            <div class="hideNotice">
                ...
                <label for="isNoticeVisible" class="label">공지 숨기기</label>
            </div>
...
<!-- 관리자용 게시판 스크립트 추가 -->
<c:if test="${isAdmin}">
  <script src="${pageContext.request.contextPath}/resource/js/admin/board/admin_boardList.js"></script>
</c:if>
<c:if test="${!isAdmin}">
